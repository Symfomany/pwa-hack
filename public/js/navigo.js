!(function(e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = t())
    : "function" == typeof define && define.amd ? define(t) : (e.Navigo = t());
})(this, function() {
  "use strict";
  var e =
      ...
      (function(e) {
        return (arguments.length > 1 && void 0 !== arguments[1]
          ...
          .map(function(t) {
                ...
                return {
                  regexp:
                    e instanceof RegExp
                      ...
                      : new RegExp(
                          e
                            .replace(n.PARAMETER_REGEXP, function(e, o, i) {
                              return t.push(i), n.REPLACE_VARIABLE_REGEXP;
                            })
                            .replace(n.WILDCARD_REGEXP, n.REPLACE_WILDCARD) +
            ...
            return !!a && { match: a, route: t, params: h };
          })
          .filter(function(e) {
            return e;
          });
  ...
  function h(e, n, o) {
    ...
    return (
      ...
      t() && !n
        ? s(e).split(o)[0]
        : (i = e.split(o)).length > 1 ? s(i[1]) : s(i[0])
    );
  }
  function u(t, n, o) {
  ...
  return (
    (n.prototype = {
      helpers: { match: r, root: a, clean: o, getOnlyURL: h },
      ...
      on: function() {
        for (
          var t = this, n = arguments.length, o = Array(n), i = 0;
          i < n;
          i++
        )
          o[i] = arguments[i];
        if ("function" == typeof o[0])
          this._defaultHandler = { handler: o[0], hooks: o[1] };
        else if (o.length >= 2)
          if ("/" === o[0]) {
            var r = o[1];
            "object" === e(o[1]) && (r = o[1].uses),
              (this._defaultHandler = { handler: r, hooks: o[2] });
      ...
      resolve: function(e) {
        ...
        return (
          ...
          a === this._lastRouteResolved.query
                    ...
                    u(
                      function() {
                        o.route.route instanceof RegExp
                          ? n.apply(void 0, o.match.slice(1, o.match.length))
                          : n(o.params, a);
                      },
                      o.route.hooks,
                      o.params,
        ...
        return (
          ...
          this._routes.push(
            "object" === (void 0 === n ? "undefined" : e(n))
              ? { route: t, handler: n.uses, name: n.as, hooks: o || n.hooks }
              : { route: t, handler: n, hooks: o }
          ),
          this._add
        );
      },
      _getRoot: function() {
        return null !== this.root
          ? this.root
          : ((this.root = a(this._cLoc().split("?")[0], this._routes)),
            this.root);
      },
      _listen: function() {
        var e = this;
